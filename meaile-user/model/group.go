...
// MeaileFriendGroup  好友分组信息。
// 说明:
// 表名:meaile_friend_group
// version:2024-08-19 17:44
type MeaileFriendGroup struct {
	Id          int64     `gorm:"column:id" json:"id"`                    //type:BIGINT       comment:主键          version:2024-08-19 17:44
	GroupName   int64     `gorm:"column:group_name" json:"groupName"`     //type:BIGINT       comment:分组名称      version:2024-08-19 17:44
